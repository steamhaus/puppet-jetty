...
define jetty::instance(
  ...
  archive { "${path}/lib/logging/slf4-api-${sf4j_version}.jar":
    ...
    extract => false,
    source  => "https://repo1.maven.org/maven2/org/slf4j/slf4j-api/${sf4j_version}/slf4j-api-${sf4j_version}.jar",
  ...
  archive { "${path}/lib/logging/slf4-log4j2-${sf4j_version}.jar":
    ...
    extract => false,
    source  => "https://repo1.maven.org/maven2/org/slf4j/slf4j-log4j12/${sf4j_version}/slf4j-log4j12-${sf4j_version}.jar",
    require => File["${path}/lib/logging"],
  }
  ...
  archive { "${path}/lib/logging/log4j-${log4j_version}.jar":
    ...
    extract => false,
    source  => "https://repo1.maven.org/maven2/log4j/log4j/${log4j_version}/log4j-${log4j_version}.jar",
    require => File["${path}/lib/logging"],
  }
